...
function showMoreText(card) {
    ...
    const text = 'Dum spiro, spero';// 6.1 сохраняем произвольный текст в переменную
    
    card.productName.insertAdjacentHTML('afterEnd', `<div class="desc">${text}</div>`); // 6.2 внутри .product есть .productName, после него вставляем div.desc и текстом из переменной из п. 6.1
